...
## -- 第一张表
## -- 1. ads_page_traffic_dashboard
## -- 统计主题：页面流量分析看板
## -- 统计内容：按统计日期、店铺ID及页面类型，统计：
## -- 页面浏览量、独立访客数、平均停留时长、跳出率、搜索次数、平均搜索排名、流量得分
## -- 数据来源：从页面流量分析表（dws_page_traffic_analysis_d）聚合处理后生成。
## -- 底层：ads_page_traffic_dashboard
## -- dws_page_traffic_analysis_d
## -- dwd_user_behavior_log
## -- ods_user_behavior_log

## -- 第二张表
## -- 2. ads_page_click_dashboard
## -- 统计主题：页面点击分布看板
## -- 统计内容：按统计日期、店铺ID及页面类型，统计：
## -- 点击次数、点击用户数、转化点击数(加购/支付)、转化率、点击得分
## -- 数据来源：从页面点击分布表（dws_page_click_distribution_d）聚合处理后生成。
## -- 底层：ads_page_click_dashboard
## -- dws_page_click_distribution_d
## -- dwd_user_behavior_log
## -- ods_user_behavior_log

## -- 第三张表
## -- 3. ads_page_guidance_dashboard
## -- 统计主题：页面引导效果看板
## -- 统计内容：按统计日期、店铺ID及页面类型，统计：
## -- 页面浏览量、引导至商品详情页浏览量、引导率、引导支付用户数、引导支付金额、引导得分
## -- 数据来源：从页面引导效果表（dws_page_guidance_effect_d）聚合处理后生成。
## -- 底层：ads_page_guidance_dashboard
## -- dws_page_guidance_effect_d
## -- dwd_user_behavior_log
## -- ods_user_behavior_log

## -- 第四张表
## -- 4. ads_comprehensive_page_analysis
## -- 统计主题：综合页面分析看板
## -- 统计内容：按统计日期、店铺ID及页面类型，统计：
## -- 流量得分、点击得分、引导得分、综合得分、等级
## -- 数据来源：从页面流量、点击、引导三个维度的ADS表合并计算生成。
## -- 底层：ads_comprehensive_page_analysis
## -- ads_page_traffic_dashboard/ads_page_click_dashboard/ads_page_guidance_dashboard
## -- dws_page_traffic_analysis_d/dws_page_click_distribution_d/dws_page_guidance_effect_d
## -- dwd_user_behavior_log
## -- ods_user_behavior_log
