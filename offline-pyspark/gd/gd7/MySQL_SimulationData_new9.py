...
REAL_PRODUCT_NAMES = [
    ...
    '优衣库摇粒绒外套', 'ZARA牛仔裤', 'H&M连衣裙',
    '美的变频空调', '格力中央空调', '海尔冰箱', '西门子洗衣机',
    'Kindle Paperwhite', 'iPad Pro 12.9', 'Surface Pro 9',
    'Apple Watch Series 9', '华为Watch GT 4', '小米手环8',
    '索尼PlayStation 5', '任天堂Switch OLED',
    '戴森吸尘器V15', '飞利浦电动牙刷',
    '兰蔻小黑瓶精华', '雅诗兰黛小棕瓶',
    '星巴克咖啡豆', '三顿半咖啡',
    '乐高经典创意积木盒', '孩之宝变形金刚'
...
PRODUCT_DESCRIPTIONS = {
    'iPhone 15 Pro': ['全新未拆封，品质保证', '官方正品，支持七天无理由退换', '高端配置，性能强劲'],
    'Samsung Galaxy S24': ['全新未拆封，品质保证', '官方正品，支持七天无理由退换', '高端配置，性能强劲'],
    '华为P70': ['全新未拆封，品质保证', '官方正品，支持七天无理由退换', '高端配置，性能强劲'],
    '小米14': ['全新未拆封，品质保证', '官方正品，支持七天无理由退换', '高性价比，性能出色'],
    'OPPO Find X7': ['全新未拆封，品质保证', '官方正品，支持七天无理由退换', '拍照神器，颜值担当'],
    'MacBook Pro 16寸': ['专业级品质，值得信赖', '高端配置，性能强劲', '轻薄便携，办公利器'],
    'Dell XPS 13': ['专业级品质，值得信赖', '高端配置，性能强劲', '轻薄便携，办公利器'],
    '华为MateBook X': ['专业级品质，值得信赖', '高端配置，性能强劲', '轻薄便携，办公利器'],
    '联想ThinkPad X1': ['专业级品质，值得信赖', '高端配置，性能强劲', '商务必备，彰显品味'],
    'AirPods Pro 2': ['无线自由，音质出色', '官方正品，支持七天无理由退换', '智能降噪，沉浸体验'],
    'Sony WH-1000XM5': ['无线自由，音质出色', '专业级品质，值得信赖', '智能降噪，沉浸体验'],
    'Bose QuietComfort 45': ['无线自由，音质出色', '专业级品质，值得信赖', '智能降噪，沉浸体验'],
    'Nike Air Jordan 1': ['明星同款，时尚潮流', '经典款式，永不过时', '舒适透气，运动必备'],
    'Adidas Ultraboost 22': ['明星同款，时尚潮流', '经典款式，永不过时', '舒适透气，运动必备'],
    'New Balance 990v5': ['明星同款，时尚潮流', '经典款式，永不过时', '舒适透气，运动必备'],
    '优衣库摇粒绒外套': ['保暖舒适，秋冬必备', '经典款式，永不过时', '高性价比，实用百搭'],
    'ZARA牛仔裤': ['时尚潮流，百搭单品', '经典款式，永不过时', '舒适修身，展现魅力'],
    'H&M连衣裙': ['时尚潮流，百搭单品', '经典款式，永不过时', '优雅大方，适合多种场合'],
    '美的变频空调': ['节能环保，绿色生活', '智能科技，便捷生活', '静音运行，舒适体验'],
    '格力中央空调': ['节能环保，绿色生活', '智能科技，便捷生活', '静音运行，舒适体验'],
    '海尔冰箱': ['节能环保，绿色生活', '智能科技，便捷生活', '大容量存储，保鲜效果好'],
    '西门子洗衣机': ['节能环保，绿色生活', '智能科技，便捷生活', '高效洗净，呵护衣物'],
    'Kindle Paperwhite': ['专业级品质，值得信赖', '轻薄便携，阅读利器', '护眼设计，舒适阅读'],
    'iPad Pro 12.9': ['专业级品质，值得信赖', '高端配置，性能强劲', '创意工具，无限可能'],
    'Surface Pro 9': ['专业级品质，值得信赖', '高端配置，性能强劲', '二合一设计，灵活高效'],
    'Apple Watch Series 9': ['智能科技，便捷生活', '健康生活，从这里开始', '时尚配饰，功能强大'],
    '华为Watch GT 4': ['智能科技，便捷生活', '健康生活，从这里开始', '时尚配饰，功能强大'],
    '小米手环8': ['智能科技，便捷生活', '健康生活，从这里开始', '高性价比，功能全面'],
    '索尼PlayStation 5': ['家庭娱乐，畅快体验', '高端配置，性能强劲', '游戏爱好者的首选'],
    '任天堂Switch OLED': ['家庭娱乐，畅快体验', '便携设计，随时随地游戏', '经典游戏，老少皆宜'],
    '戴森吸尘器V15': ['智能家居，洁净生活', '高效清洁，省时省力', '科技感设计，品质卓越'],
    '飞利浦电动牙刷': ['健康生活，从这里开始', '专业护理，洁净口腔', '智能提醒，科学刷牙'],
    '兰蔻小黑瓶精华': ['专业护肤，品质保证', '明星产品，口碑之选', '深层滋养，焕发肌肤活力'],
    '雅诗兰黛小棕瓶': ['专业护肤，品质保证', '明星产品，口碑之选', '抗老修复，肌肤年轻态'],
    '星巴克咖啡豆': ['品质保证，香醇可口', '精选原料，口感丰富', '提神醒脑，享受时光'],
    '三顿半咖啡': ['品质保证，香醇可口', '便捷冲泡，随时随地享受', '网红产品，时尚之选'],
    '乐高经典创意积木盒': ['益智玩具，启发思维', '品质保证，安全无毒', '创意无限，乐趣无穷'],
    '孩之宝变形金刚': ['益智玩具，启发思维', '经典IP，童年回忆', '可玩性强，收藏价值高']
}
...
# 更多真实品类
REAL_CATEGORIES = [
    '手机数码', '电脑办公', '家用电器', '服装鞋帽', '运动户外',
    '家居用品', '图书音像', '美妆个护', '母婴用品', '食品饮料',
    '汽车用品', '珠宝首饰', '钟表眼镜', '游戏装备', '宠物用品',
    '医疗保健', '旅游度假', '金融服务', '教育培训', '房产装修'
]
...
VALUE_GENERATION_RULES = {
    ...
    'category': lambda field, context: random.choice(REAL_CATEGORIES),
...
def generate_realistic_name(field, context):
    ...
    # 用户相关名称
    if 'user' in field_name or 'login' in field_name or 'nick' in field_name:
        ...
        if suffix_type == 'number':
            ...
            suffix = ''.join(random.choices('abcdefghijklmnopqrstuvwxyz', k=random.randint(3, 6)))
        else:  # mixed
...
def generate_product_description(field, context):
    # 如果上下文中有商品名称，则根据商品名称生成匹配的描述
    if 'sku_name' in context:
        product_name = context['sku_name']
        descriptions = PRODUCT_DESCRIPTIONS.get(product_name, REAL_PRODUCT_NAMES)
        if isinstance(descriptions, list):
            return random.choice(descriptions)
        else:
            return random.choice(PRODUCT_DESCRIPTIONS.get(descriptions, ['高端配置，性能强劲']))
        ...
        # 随机选择一个商品名称并生成对应描述
        product_name = random.choice(REAL_PRODUCT_NAMES)
        descriptions = PRODUCT_DESCRIPTIONS.get(product_name, ['高端配置，性能强劲'])
        if isinstance(descriptions, list):
            return random.choice(descriptions)
        else:
            return descriptions
