...
# 更多真实图片URL模板
REAL_IMAGE_URLS = [
    'https://example.com/images/product1.jpg', 'https://example.com/images/product2.jpg',
    'https://example.com/images/product3.jpg', 'https://example.com/images/product4.jpg',
    'https://example.com/images/product5.jpg', 'https://example.com/images/product6.jpg',
    'https://example.com/images/product7.jpg', 'https://example.com/images/product8.jpg',
    'https://example.com/images/product9.jpg', 'https://example.com/images/product10.jpg',
    'https://example.com/images/item1.png', 'https://example.com/images/item2.png',
    'https://example.com/images/item3.png', 'https://example.com/images/item4.png',
    'https://example.com/images/item5.png', 'https://example.com/images/item6.png',
    'https://example.com/images/goods1.webp', 'https://example.com/images/goods2.webp',
    'https://example.com/images/goods3.webp', 'https://example.com/images/goods4.webp'
]
...
VALUE_GENERATION_RULES = {
    ...
    'description': lambda field, context: random.choice(REAL_PRODUCT_DESCRIPTIONS),
    ...
    'url': lambda field, context: random.choice(REAL_IMAGE_URLS),
    ...
    'image': lambda field, context: random.choice(REAL_IMAGE_URLS),
...
def generate_realistic_name(field, context):
    ...
    if 'user' in field_name or 'login' in field_name or 'nick' in field_name:
        ...
        # 50%概率使用拼音，50%使用中文名+数字
        if random.random() < 0.5:
            pinyin = USER_NAME_PINYIN.get(name, name.lower())
            return f"{pinyin}{random.randint(100, 9999)}"
        else:
            return f"{name}{random.randint(100, 9999)}"

    # 商品相关名称
    elif 'sku' in field_name or 'spu' in field_name or 'product' in field_name:
        return random.choice(REAL_PRODUCT_NAMES) + " " + str(random.randint(100, 999))
    ...
    # 通用名称
        ...
        if random.random() < 0.7:
            ...
            return f"{name}_{random.randint(1000, 99999)}"
...
def generate_realistic_general_value(field, context):
    ...
    if 'img' in field_name or 'image' in field_name:
        # 添加随机参数避免重复
        base_url = random.choice(REAL_IMAGE_URLS)
        return f"{base_url}?v={random.randint(1000, 9999)}"
        ...
        return random.choice(REAL_PRODUCT_DESCRIPTIONS)
    elif 'head' in field_name:
        base_url = random.choice(REAL_IMAGE_URLS)
        return f"{base_url}?avatar={random.randint(1000, 9999)}"
    elif 'url' in field_name:
        base_url = random.choice(REAL_IMAGE_URLS)
        return f"{base_url}?t={random.randint(1000, 9999)}"
